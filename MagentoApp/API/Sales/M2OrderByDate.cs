...
{
    public class M2OrderByDateBillingAddress
    {
    ...
    public class M2OrderByDatePayment
    {
    ...
    public class M2OrderByDateStatusHistory
    {
    ...
    public class M2OrderByDateAddress
    {
    ...
    public class M2OrderByDateTotal
    {
    ...
    public class M2OrderByDateShipping
    {
    ...
    public class M2OrderByDateShippingAssignment
    {
        ...
        [JsonProperty("items")]
        public IList<M2OrderItem> items { get; set; }
    }

    public class M2OrderByDateExtensionAttributes
    {
    ...
    public class M2OrderByDatesItems
    {
        ...
        public M2OrderByDateBillingAddress billing_address { get; set; }
    ...
    public class M2OrderByDates
    {

        [JsonProperty("items")]
        public IList<M2OrderByDatesItems> items { get; set; }
